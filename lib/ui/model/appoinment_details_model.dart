...
class AppoinmentDetailsModel {
  String? code;
  String? message;
  Data? data;

  AppoinmentDetailsModel({this.code, this.message, this.data});

  AppoinmentDetailsModel.fromJson(Map<String, dynamic> json) {
    code = json['code'].toString();
    message = json['message'];
    print("AppoinmentDetailsModel line 13");
    print(json['data']);
  ...
  Map<String, dynamic> toJson() {
    ...
    print("AppoinmentDetailsModel line 20");
    print(this.data);
    if (this.data != null) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    //   print("AppoinmentDetailsModel line 69");
    //   print(json['car_details']);
    //   carDetails = <CarDetails>[];
...
//   GarageDetails({this.id, this.garageId, this.garageName});
