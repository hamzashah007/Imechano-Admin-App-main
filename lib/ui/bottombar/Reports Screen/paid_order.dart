...
class PaidOrder extends StatefulWidget {
  final String? status;
  const PaidOrder({Key? key, this.status}) : super(key: key);

  @override
  _PaidOrderState createState() => _PaidOrderState();
}

class _PaidOrderState extends State<PaidOrder> {
  List plateNo = [
    'A DUBAI 005',
  ];
  List garageAss = [
