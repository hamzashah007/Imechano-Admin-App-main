...
class Averageticket extends StatefulWidget {
  final String? status;
  const Averageticket({Key? key, this.status}) : super(key: key);

  @override
  _AverageticketState createState() => _AverageticketState();
}

class _AverageticketState extends State<Averageticket> {
  int selectedindex = 1;
  List DataList = [
    ToalCustom(),
    ToalCustom1(),
                      ...
                      child: Card(
                        ...
                        child: Center(
                          child: DataTable(
                            ...
                            rows: List.generate(
                              reports?.reports?.averageTicket!.length ?? 0,
                              (index) {
                                return DataRow(
                                    ...
                                    cells: [
                                      ...
                                      DataCell(Center(
                                          child: Text(
                                        reports?.reports?.averageTicket![index]
                                                .customerId! ??
                                            "",
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                      ...
                      child: Card(
                        ...
                        child: Center(
                          child: DataTable(
                            ...
                            rows: List.generate(
                              reports?.reports?.averageTicketSizeComplete!
                                      .length ??
                                  0,
                              (index) {
                                return DataRow(
