...
class TodayCount extends StatefulWidget {
  final String? status;
  const TodayCount({Key? key, this.status}) : super(key: key);

  @override
  _TodayCountState createState() => _TodayCountState();
}

class _TodayCountState extends State<TodayCount> {
  int selectedindex = 1;
                              ...
                              child: Card(
                                ...
                                child: Center(
                                  child: DataTable(
                                    ...
                                    rows: List.generate(
                                      reports?.reports?.todayBooking!.length ??
                                          0,
                                      (index) {
                                        return DataRow(
                                            color:
